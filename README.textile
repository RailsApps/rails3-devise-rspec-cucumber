...
h2. !http://twitter-badges.s3.amazonaws.com/t_logo-a.png(Follow on Twitter)!:http://www.twitter.com/rails_apps Follow on Twitter !http://cloud.github.com/downloads/RailsApps/railsapps.github.com/mailing-list-icon.jpg(Join the Mailing List)!:http://eepurl.com/dQx3o Join the Mailing List
...
h2. !http://cloud.github.com/downloads/RailsApps/railsapps.github.com/rails-36x36.jpg(Tutorial)! Tutorial
...
For *Rails 3.1*, use the command:

@$ rails new APP_NAME -m https://github.com/fortuity/rails3-application-templates/raw/master/rails3-devise-rspec-cucumber-template.rb@

For *Rails 3.0*, add the @-T -J@ flags to skip Test::Unit files and Prototype files:
